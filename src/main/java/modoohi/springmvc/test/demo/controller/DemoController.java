...
public class DemoController {
	 ...
	 * @return
	 */	
	@RequestMapping(value="/demoJQKGrid/{gName}", method = RequestMethod.GET)
	@ResponseBody	
	public Map<String, Object> searchDemoJQKGridJsonDataByGet2(@PathVariable String gName
													, @RequestParam("user_id") String user_id
													, @RequestParam("inv_date") String inv_date
													, @RequestParam("name") String name
													, @RequestParam("amount") String amount
		...
		try {
			...
			resultDataMap.put("rows", resultList);
			resultDataMap.put("rowCount", resultList.size());
