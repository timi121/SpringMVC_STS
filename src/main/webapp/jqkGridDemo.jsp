...
<head>
	...
	<title>jqkGrid Demos</title>
	<script src="resources/js/jqkGridCommInclude.js" type="text/javascript"></script>
	<script type="text/javascript">
		var gData = [//바인드 될 데이터.. 객체배열 형태..
		             {no:"1",nm:"홍길동",ssn:"83XXXX-XXXXXXX",job:"개발자",position:"ㅋㅋㅋ",hobby:"Golf",addr:"서울"},
		             {no:"2",nm:"김마리",ssn:"83XXXX-XXXXXXX",job:"개발자",position:"ㅋㅋㅋ",hobby:"Golf",addr:"서울"},
		             {no:"3",nm:"박말자",ssn:"83XXXX-XXXXXXX",job:"개발자",position:"ㅋㅋㅋ",hobby:"Golf",addr:"서울"},
		             {no:"4",nm:"견미리",ssn:"83XXXX-XXXXXXX",job:"개발자",position:"ㅋㅋㅋ",hobby:"Golf",addr:"서울"},
		             {no:"1",nm:"홍길동",ssn:"83XXXX-XXXXXXX",job:"개발자",position:"ㅋㅋㅋ",hobby:"Golf",addr:"서울"},
		             {no:"2",nm:"김마리",ssn:"83XXXX-XXXXXXX",job:"개발자",position:"ㅋㅋㅋ",hobby:"Golf",addr:"서울"},
		             {no:"3",nm:"박말자",ssn:"83XXXX-XXXXXXX",job:"개발자",position:"ㅋㅋㅋ",hobby:"Golf",addr:"서울"},
		             {no:"4",nm:"견미리",ssn:"83XXXX-XXXXXXX",job:"개발자",position:"ㅋㅋㅋ",hobby:"Golf",addr:"서울"},
		...
		$(function(){
			//그리드초기화..
			$(".grid").jqkGrid("init",{
				gridTitle : "My First jqkGrid!!",
				colSizes : [50, 90, 90, 150, 150, 150, 150],//칼럼들의 사이즈는 배열로 표시(픽셀)
				...
				bodyCells : [[{bindCol:"no"},{bindCol:"nm"},{bindCol:"ssn"},{bindCol:"job"},
				                {bindCol:"position"},{bindCol:"hobby"},{bindCol:"addr"}]],//마찬가지로 바디가 여러 행일 수 있으니 2중배열로 표시..
				fixedCols : 0,
				none : ""
			});
			//그리드에 데이터를 바인딩..
			$(".grid").jqkGrid("bind",gData);
		...
		<div id="jqkGrid" style="WIDTH: 670px;" class="jqkg ui-widget ui-widget-content">
			...
			<div class="jqkg-content" style="height:200px">
				...
				<div class="jqkg-table" style="width:652px;height:182px;position:relative"">
					<div class="jqkg-table-hl" style="width:200px">
					...
					<div class="jqkg-table-hr" style="width:452px">
 					...
 					<div class="jqkg-table-bl" style="width:200px">
